...
public class FisheomancyAlterScreen extends HandledScreen<FisheomancyAlterScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(Fishe.MOD_ID,"textures/gui/fisheomancy_alter_gui.png");
    public FisheomancyAlterScreen(FisheomancyAlterScreenHandler handler, PlayerInventory inventory, Text title) {
