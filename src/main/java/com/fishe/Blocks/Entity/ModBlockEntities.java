...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<FisheomancyAltarBlockEntity> FISHEOMANCY_ALTAR_BLOCK_ENTITY_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(Fishe.MOD_ID,"fisheomancy_altar_be"),
                    FabricBlockEntityTypeBuilder.create(FisheomancyAltarBlockEntity::new,BlockMaster.FISHEOMANCY_ALTAR).build());
